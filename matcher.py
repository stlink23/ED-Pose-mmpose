...
import numpy as np
from .transformers.box_ops import box_cxcywh_to_xyxy,generalized_box_iou
...
class HungarianMatcher(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        cost_giou = -generalized_box_iou(box_cxcywh_to_xyxy(out_bbox.float()), box_cxcywh_to_xyxy(tgt_bbox.float()))
